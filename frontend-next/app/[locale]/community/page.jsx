...
export async function generateMetadata({ params }) { const { locale } = await params; const copy = isLocale(locale) ? discoveryLandings[locale].community : null; return copy ? pageMetadata({ locale, path: 'community', title: locale === 'hi' ? 'KalQLater कम्युनिटी: जुड़ें, खोजें और सहयोग करें' : 'KalQLater Community: Discover, Connect, Collaborate', description: copy.description }) : {}; }
