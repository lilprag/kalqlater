...
export default async function ConflictResultPage({ params }) { const { locale, resultId } = await params; if (!isLocale(locale) || !isAssessmentLocaleSupported('conflict', locale) || !/^[a-z0-9-]{20,}$/i.test(resultId)) notFound(); return <ConflictResult locale={locale} resultId={resultId} />; }
