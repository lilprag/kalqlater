...
function GrowthDashboard({ locale }) {
  ...
  const recommendationHref = recommendation === 'personality' ? productionAppUrl('/test') : recommendation === 'communication' ? `/${locale}/insights/communication` : `/${locale}/community`;
  const recommendationText = recommendation === 'personality' ? c.startPersonality : recommendation === 'communication' ? c.startCommunication : c.startCommunity;
