...
import { FUTURE_INSIGHTS, loadGrowthDashboard, nextDashboardRecommendation } from '../../lib/growth-dashboard';
...
const copy = {
  en: {
    ...
    startPersonality: 'Take the personality test', startCommunication: 'Explore Communication Insights', startDecision: 'Explore Decision Style', startCommunity: 'Explore Community',
    ...
    personality: 'Personality', communication: 'Communication', decision: 'Decision', conflict: 'Conflict', leadership: 'Leadership', learning: 'Learning',
  ...
  hi: {
    ...
    startPersonality: 'पर्सनैलिटी टेस्ट दें', startCommunication: 'कम्युनिकेशन इनसाइट्स देखें', startDecision: 'डिसीजन स्टाइल देखें', startCommunity: 'कम्युनिटी देखें',
    ...
    personality: 'पर्सनैलिटी', communication: 'कम्युनिकेशन', decision: 'डिसीजन', conflict: 'कन्फ्लिक्ट', leadership: 'लीडरशिप', learning: 'लर्निंग',
...
const icon = { personality: '◌', communication: '↗', decision: '◇', conflict: '≈', leadership: '✦', learning: '○' };
...
function GrowthDashboard({ locale }) {
  ...
  const recommendationHref = recommendation === 'personality' ? productionAppUrl('/test') : recommendation === 'communication' ? `/${locale}/insights/communication` : recommendation === 'decision' ? `/${locale}/insights/decision` : `/${locale}/community`;
  const recommendationText = recommendation === 'personality' ? c.startPersonality : recommendation === 'communication' ? c.startCommunication : recommendation === 'decision' ? c.startDecision : c.startCommunity;
