...
const sessionCopy = {
  ...
  ja: {
    expired: 'このセッションは期限切れです。新しい振り返りを始められます。',
    timeout: '応答に時間がかかっています。接続を確認して、もう一度お試しください。',
    unavailable: 'この体験はまだ公開されていません。内容の確認が完了すると利用できます。',
    error: 'この操作を完了できませんでした。もう一度お試しください。',
    responseGuidance: '理想的に見える答えではなく、普段の自分に最も近いものを選んでください。',
    starting: '開始しています…',
    disclaimer: 'これは振り返りのためのガイドであり、診断や評価ではありません。',
    sessionUnavailable: 'このセッションは利用できません',
    beginNewReflection: '続けるには、新しい振り返りを始めてください。',
    loadingTitle: 'コミュニケーションの傾向を確認しています…',
    loadingBody: '次の場面を読み込んでいます。ここまでの進み具合は保持されています。',
    tryAgain: 'もう一度試す',
    progressPrefix: '進捗 ',
    progressLabel: '振り返りの進捗',
    usualAction: '普段のあなたなら、どうしますか？',
    chooseResponse: '回答を選んでください',
    leaveConfirmLabel: '振り返りを中断するか確認',
    leaveConfirmTitle: 'いったん振り返りを離れますか？',
    leaveConfirmBody: 'このブラウザーではセッションが保持され、このリンクから再開できます。',
    stay: '続ける',
    goToStart: '最初に戻る',
    back: '戻る',
    saving: '保存しています…',
    continue: '次へ',
    placeHeld: 'ここまでの進み具合は、このブラウザーのセッションに保持されます。',
    retry: '再試行',
    startAgain: 'もう一度始める',
  },
};
