...
export function typeFaq(profile, locale) {
  ...
  return [
    ...
    { q: hi ? `${profile.code} काम में क्या खोज सकता है?` : `What may an ${profile.code} look for at work?`, a: profile.workStyle?.[0] || (hi ? 'वास्तविक भूमिका, टीम और मूल्य सबसे अधिक मायने रखते हैं।' : 'The actual role, team, and values matter most.') },
