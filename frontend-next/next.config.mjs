...
const nextConfig = {
  ...
  async rewrites() {
    ...
    return {
      ...
      beforeFiles: [
        ...['/test/:path*', '/result/:path*', '/report/:path*', '/types/:path*', '/about/:path*', '/privacy/:path*', '/terms/:path*', '/contact/:path*', '/compare/:path*', '/community/:path*', '/login/:path*', '/signup/:path*', '/forgot-password/:path*', '/reset-password/:path*', '/api/:path*', '/static/:path*'].map(proxy),
